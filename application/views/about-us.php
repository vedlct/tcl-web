                ...
                <div class="main_content_wrapper">
                        ...
                        <div class="row">
                            <div class="content_title about_title">
                                ...
                                <p style="margin:0"><strong>Tech Cloud</strong> has been selected as one of the top IT companies in Bangladesh
                                            ...
                                            <p>Reference link - <a href="http://www.intracen.org/itc/projects/ntf-3/bangladesh" target="_blank">www.intracen.org/itc/projects/ntf-3/bangladesh</a></p>
                                <div class="row content_title designed-grid-box" style="padding-bottom:0; padding-top:50px">
                                            <div class="col-md-6">
                                                <ul class="list-ic vertical" style="height: 315px;">
                                                    <li>
                                                        <h4>Our Bio</h4>
                                                        <span><i class="fa fa-file-text-o" aria-hidden="true"></i></span>
                                                        <p style="padding: 15px 10px;">With a team of dedicated and hardworking professionals, Tech Cloud Ltd. successfully delivering industry standard 
                                                        and flexible services to clients in different business sector of IT industry including e-commerce image processing, 
                                                        desktop publishing, graphic design, logo design, website development, software development etc.</p>
                                                    </li>       
                                                </ul>		
                                            </div>
                                            <div class="col-md-6">
                  ...
                  <div class="container">
                        <div class="row">
                            ...
                            <div class="content_title how-we-work text-center" style="padding-top:0">
                                <h3>How We Work</h3>
                                <hr />
                                
                                <ul id="grid-list" class="grid-layout">
										<!-- Works Item 01 -->
										<li class="col-md-12 col-sm-12 masonry_item webd web">
											<a href="<?php echo base_url()?>public/images/tcl-how-we-work.png" data-group="1" class="galleryItem" title="How we work"><div class="work_content">
												<img src="<?php echo base_url()?>public/images/tcl-how-we-work.png" alt="" />
