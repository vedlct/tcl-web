                    ...
                    <div class="container">
                        <div class="row">
                            <div class="content_title about_title">
                                <h3>Our Corporate Social Responsibilities</h3>
                                <hr />
                                
                                <!--<div class="row content_title designed-grid-box" style="padding-bottom:0; padding-top:0px">
                                            <div class="col-md-6">
                                                <ul class="list-ic vertical" style="height: 150px;">
                                                    <li>
                                                        
                                                        <p style="padding: 15px 10px;">Encouraging women to join our team and lead the industry, we wish
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list-ic vertical" style="height:150px;">
                                                    <li>
                                                        ...
                                                        <p style="padding: 15px 10px;">Offering rural and under privileged individual to take part in our internship
														program and then hiring them as full time employment.</p>
                                                    </li>       
                                                </ul>		
                                            </div>
                                </div>
                                <div class="row content_title designed-grid-box" style="padding-bottom:0; padding-top:30px">
                                            <div class="col-md-6">
                                                <ul class="list-ic vertical" style="height: 150px;">
                                                    <li>
                                                        
                                                        <p style="padding: 15px 10px;">Working with Bangladesh Govt. vision 2021 to achieve 5 billion usd
                                            ...
                                            <div class="col-md-6">
                                                <ul class="list-ic vertical" style="height:150px;">
                                                    <li>
                                                        ...
                                                        <p style="padding: 15px 10px;">Financial contribution to the inhabitants of Northern
