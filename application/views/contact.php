...
<section id="contact">
    ...
    <div class="andazi_back">
        <div class="sub_hero_title " style="margin-top: -20px;">
            <h3 class="inside_site_title contact_logo"><img style="position:absolute; top:30px; left:30px" src="<?php echo base_url()?>public/images/tcl-logo.png" alt="TCL Logo" width="80"></h3>
                                    ...
                                    <div class="info-back-box" style="background-image: url(<?php echo base_url()?>public/images/contact/sub_hero.jpg);">
                                        <div class="inner info-box">
                                            ...
                                            <p class="description">
                                                ...
                                                E-Mail: <a style="color: #1BC4F5;" href="mailto:someone@example.com?Subject=Hello%20again" target="_top">support@techcloudbd.com</a>
                                    ...
                                    <div class="info-back-box" style="background-image: url(<?php echo base_url()?>public/images/contact/sub_hero.jpg);">
                                        <div class="inner info-box">
                                            ...
                                            <p class="description">
                                                ...
                                                E-Mail: <a style="color: #1BC4F5;" href="mailto:someone@example.com?Subject=Hello%20again" target="_top">uk@techcloudbd.com</a>
                                    ...
                                    <div class="info-back-box" style="background-image: url(<?php echo base_url()?>public/images/contact/sub_hero.jpg);">
                                        <div class="inner info-box">
                                            ...
                                            <p class="description">
                                                ...
                                                112 sweetbriar crt Pickering <br>
                                                ON L1v6r2, Toronto <br>
                                                Phone: +1(438) 765-2901 <br>
                                                E-Mail: <a style="color: #1BC4F5;" href="mailto:someone@example.com?Subject=Hello%20again" target="_top">canada@techcloudbd.com</a>
