    ...
    <div class="andazi_back">
        <div class="sub_hero_title" style="margin-top: -20px;">
            ...
            <div class="sub_title">
                ...
                <h3>Professional Search Engine Optimization</h3>
                <hr />
            </div>
        </div>
        ...
        <div class="main_content_wrapper">
            <div class="container">
                <div class="row">
                    <br><br><br>
                    <div align="center"><h3><b>Why Do You Need SEO? </b></h3>
                         </div>
                    <br><br><br>
                    ...
                    <div class="col-sm-6 " >
                        ...
                        <div class="row">
                            ...
                            <div style="float: left; width: 480px; text-align: justify;" class="col-lg-4">
                                <h4><b>More Website Traffic</b></h4>
                                <span style="text-align: justify">Our expertise uses the latest tools for professional seo practices,  content implementation, and backlink support to ensure maximum website traffic. The website presents your product or service to transform visitors into potential customers. </span>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div style="float: left; width: 480px; text-align: justify;" class="col-lg-4">
                                <h4><b>Low-Cost Client Acquisition</b></h4>
                                <span style="text-align: justify">Who does not love to maximize revenue and minimize cost? Professional Search Engine Optimization considered as the most affordable marketing approach than any other approaches. Millions of successful business take SEO as granted to rank in the first position. </span>
                            </div>
                            <div style="float: right;" class="col-lg-2">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div style="float: right;  width: 480px; text-align: justify;" class="col-lg-4">
                                <h4><b>Business Easy-Discoverable</b></h4>
                                <span style="text-align: justify">Rank your website top of the first page of SERP (search engine results page) with professional SEO service. With our proficient and effective approach at an affordable price, make your website discoverable right away. </span>
                            </div>
                        ...
                        <div class="row" >
                            ...
                            <div style="float: right ; width: 480px; text-align: justify;" class="col-lg-4">
                                <h4><b>Branding</b></h4>
                                <span style="text-align: justify">Branding is one of the most prominent aspects of a business. Among the branding strategies, SEO considered as an effective strategy as it enables the business to appear in the top of ranking allows the customer to evaluate and determine your brand value.</span>
                            </div>
